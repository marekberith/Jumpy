...
window.onload = function()
{
    ...
    notSupportedDevice = function()
    {
        document.getElementById('loaded').style.display = "none";
        document.getElementById('notLoaded').style.display = "none";
        document.getElementById('deviceCheck').style.visibility = "visible";
    }
    playaGame = function(){
        game.execute();
    };
    if(deviceCheck() === false)
        functionHandler();  //pri onload spúšťam functionHandler, ktorý volá daľšie funkcie
    else
        notSupportedDevice();
};
